...
import com.agent.authentication.DeviceClientAuthenticationProvider;
import com.agent.federation.FederatedIdentityIdTokenCustomizer;
import com.agent.jose.Jwks;
import com.agent.web.authentication.DeviceClientAuthenticationConverter;
...
public class AuthorizationServerConfig {
	...
	public JdbcRegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
		RegisteredClient messagingClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				.redirectUri("https://localhost:8080/login/oauth2/code/messaging-client-oidc")
				.redirectUri("https://loalhost:8080/authorized")
